...
namespace OpenInputOSD
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBox2.Text = "Mouse (System.Windows.Forms.MouseButtons)";
			...
			this.button1.Click += new System.EventHandler(this.b_StartStopOverlay);
			// 
			// label2
			// 
			...
			// numericUpDown5
			// 
			this.numericUpDown5.Location = new System.Drawing.Point(60, 116);
			...
			// numericUpDown6
			// 
			this.numericUpDown6.Location = new System.Drawing.Point(60, 138);
			...
			this.button2.Text = "Fill Unpressed";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.b_CellFillUnpressed);
			// 
			// button3
			// 
			...
			this.button3.Text = "Fill Pressed";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.b_CellFillPressed);
			// 
			// button4
			// 
			...
			this.button4.Text = "Outline";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.b_CellOutline);
			// 
			// textBox2
			// 
			...
			this.button5.Text = "Fill Unpressed";
			this.button5.UseVisualStyleBackColor = true;
			this.button5.Click += new System.EventHandler(this.b_TextFillUnpressed);
			// 
			// numericUpDown7
			// 
			this.numericUpDown7.Location = new System.Drawing.Point(58, 191);
			...
			// numericUpDown8
			// 
			this.numericUpDown8.Location = new System.Drawing.Point(58, 213);
			...
			this.button6.Text = "Fill Pressed";
			this.button6.UseVisualStyleBackColor = true;
			this.button6.Click += new System.EventHandler(this.b_TextFillPressed);
			// 
			// button7
			// 
			...
			this.button7.Text = "Outline";
			this.button7.UseVisualStyleBackColor = true;
			this.button7.Click += new System.EventHandler(this.b_TextOutline);
			// 
			// MainForm
			// 
